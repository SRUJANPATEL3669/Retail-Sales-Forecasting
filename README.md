...
An end-to-end retail demand forecasting project that predicts weekly sales across **45 stores**, **81 departments**, and **420K+ records** using statistical time-series models and machine learning. The project combines business analytics, feature engineering, predictive modelling, model evaluation, and an interactive **Streamlit dashboard** for exploring forecasting performance and retail sales insights.
...
The project has been extended with an interactive **Streamlit dashboard** for exploring forecasting results.
...
```bash
git clone https://github.com/SRUJANPATEL3669/Retail-Sales-Forecasting.git
...
- Add direct future-date forecasting from the Streamlit interface
- Add interactive model selection
- Add forecast confidence intervals
- Compare additional forecasting models such as Prophet and LightGBM
- Explore deep learning models such as LSTM
- Add automated periodic model retraining
- Add sales anomaly detection
- Add promotion impact analysis
- Add richer store and department comparisons
...
```text
Repository: SRUJANPATEL3669/Retail-Sales-Forecasting
Branch: main
Main file: app.py
```
